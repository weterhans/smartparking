...
void evaluasiFitur() {
  ...
  // ── FILTER NON-MOBIL (Orang, Motor, dll) DIHILANGKAN ──
  // Membiarkan objek kurang dari 2.5 meter (orang, motor) tetap diproses
  // dan diteruskan ke tahap ekstraksi fitur & klasifikasi KNN.
